...
public class EditOrderUploadActivity extends Activity implements DatePickerDialog.OnDateSetListener, com.wdullaer.materialdatetimepicker.date.DatePickerDialog.OnDateSetListener {
	// LogCat tag
    ...
    Switch flagSwitch, flagPaymntStatus;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_upload_edit_order);
        ...
        imageViewBckHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EditOrderUploadActivity.this, ParticularOrderDetail.class);
        ...
        imageViewInvoiceUpload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EditOrderUploadActivity.this, EditOrderInvoiceUploadActivity.class);
		...
		if (isImage) {
           ...
           // matrix.postRotate(90);
            ...
            imgPreview.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(EditOrderUploadActivity.this, FullscreenInvoice.class);
	...
	private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
		...
		private String uploadFile() {
			...
			HttpPost httppost = new HttpPost(Config.FILE_UPLOAD_EDIT_ORDER);
			...
			try {
                ...
                entity.addPart("paid", new StringBody(paymentStatus));
